...
                <input type="text" class="form-control" v-model="formData.username" label="Username"
id="Username">
                <p v-for="error in v$.username.$errors" :key="error.$uid" class="text-danger m-0"> {{
error.$message }}</p>
            </div>
            <div class="col-md-8 position-relative">
                <label for="Email" class="form-label">Correo</label>
                <input type="email" class="form-control" v-model="formData.email" label="Email"
id="Email">
